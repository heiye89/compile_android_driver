...
#define LKAPI_RESOLVE_ERR(name, label)                                         \
    do {                                                                       \
...
#define LKAPI_RESOLVE(name) LKAPI_RESOLVE_ERR(name, err_##name)
...
LKAPI_DECLARE(get_current,       fp_get_current);
...
#define GET_CURRENT()                                                          \
    lkapi_get_current(_p_get_current)
